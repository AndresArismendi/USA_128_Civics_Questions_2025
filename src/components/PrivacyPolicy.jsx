        ...
        <div className="start-page" style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem', textAlign: 'left' }}>
            <div className="content-card">
                ...
                <p>
                    ...
                    <a href="https://policies.google.com/technologies/ads" target="_blank" rel="noopener noreferrer" style={{ color: '#90cdf4' }}>https://policies.google.com/technologies/ads</a>
                </p>
